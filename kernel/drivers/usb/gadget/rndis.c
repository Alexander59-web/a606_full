...
int rndis_msg_parser(u8 configNr, u8 *buf)
{
	...
	case REMOTE_NDIS_HALT_MSG:
		pr_debug("%s: REMOTE_NDIS_HALT_MSG\n",
			__func__);
		xlog_printk(ANDROID_LOG_INFO, RNDIS_LOG,"rndis_msg_parser, REMOTE_NDIS_HALT_MSG\n") ;
...
{
	seq_printf(m, "[RNDIS] rx_in %d, rx_out %d, rx_nomem %d, rx_error %d, tx_in %d, tx_out %d, tx_busy %d, tx_complete %d, last_msg_id: 0x%x, last_resp_id: 0x%x, RNDIS reset cnt: 0x%d, queue stopped? %d\n", 
	rndis_test_rx_usb_in, rndis_test_rx_net_out, rndis_test_rx_nomem, rndis_test_rx_error, rndis_test_tx_net_in, 
	rndis_test_tx_usb_out, rndis_test_tx_busy , rndis_test_tx_complete, rndis_test_last_msg_id, rndis_test_last_resp_id, rndis_test_reset_msg_cnt, 
...
static struct test_proc_dir_entry *rndis_test_proc ;
