...
static void sii9024_suspend(void)
{
	...
	#endif
	#if defined(GPIO_PCM_TX_OR_I2S_DAT_SEL_PIN)
		#if defined(GPIO_HDMI_I2S_OUT_DAT_PIN)
			mt_set_gpio_mode(GPIO_HDMI_I2S_OUT_DAT_PIN, GPIO_MODE_02); // (PCM_TX)
		#endif
		mt_set_gpio_dir(GPIO_PCM_TX_OR_I2S_DAT_SEL_PIN, GPIO_DIR_OUT); // Select pin
		mt_set_gpio_out(GPIO_PCM_TX_OR_I2S_DAT_SEL_PIN, GPIO_OUT_ONE); // Select pin (Connect GPIO_HDMI_I2S_OUT_DAT_PIN to AP_PCM_TX)
	#endif
}
/*----------------------------------------------------------------------------*/
...
static void sii9024_resume(void)
{
	...
	#if defined(GPIO_PCM_TX_OR_I2S_DAT_SEL_PIN)
		#if defined(GPIO_HDMI_I2S_OUT_DAT_PIN)
			mt_set_gpio_mode(GPIO_HDMI_I2S_OUT_DAT_PIN, GPIO_MODE_03); // (I2SOUT_DATA_OUT)
		#endif
		mt_set_gpio_dir(GPIO_PCM_TX_OR_I2S_DAT_SEL_PIN, GPIO_DIR_OUT); // Select pin
		mt_set_gpio_out(GPIO_PCM_TX_OR_I2S_DAT_SEL_PIN, GPIO_OUT_ZERO); // Select pin (Connect GPIO_HDMI_I2S_OUT_DAT_PIN to I2S_DAT_OUT)
	#endif
}
/*----------------------------------------------------------------------------*/
