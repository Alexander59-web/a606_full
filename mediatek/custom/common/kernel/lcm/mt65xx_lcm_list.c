...
//gionee lihl add for TCL lcm
#if defined(GN_TCL_HX8379C)
extern LCM_DRIVER hx8379c_fwvga_dsi_vdo_tcl_lcm_drv;
#endif

//gionee lihl add for TRULY lcm
#if defined(GN_TRULY_HX8379C)
extern LCM_DRIVER hx8379c_fwvga_dsi_vdo_truly_lcm_drv;
#endif
extern LCM_DRIVER ili9806_dsi_vdo_lcm_drv;
extern LCM_DRIVER hx8379a_dsi_vdo_lcm_drv_tcl;
...
#endif
#if defined(HX8379A_FWVGA_DSI_VDO)
 &hx8379a_dsi_vdo_lcm_drv_tcl,
#endif
...
//gionee lihl add for TRULY lcm
#if defined(GN_TRULY_HX8379C)
  &hx8379c_fwvga_dsi_vdo_truly_lcm_drv,
#endif
};
