...
extern struct MTKFB_MMP_Events_t
{
    ...
    // DDP-SVP
    MMP_Event StartSecure;
    MMP_Event StopSecure;
    MMP_Event ConfigWDMASecure;
    MMP_Event ConfigRDMASecure;
    MMP_Event OvlReset;
    MMP_Event ClearWDMAIntr;
    MMP_Event ClearRDMAIntr;
    MMP_Event DciSessionError;
#endif
