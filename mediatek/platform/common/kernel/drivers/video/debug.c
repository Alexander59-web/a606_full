...
void init_mtkfb_mmp_events(void)
{
    if (MTKFB_MMP_Events.MTKFB == 0)
    {
        ...
        MTKFB_MMP_Events.StartSecure = MMProfileRegisterEvent(MTKFB_MMP_Events.UpdateConfig, "StartSecure");
        MTKFB_MMP_Events.StopSecure = MMProfileRegisterEvent(MTKFB_MMP_Events.UpdateConfig, "StopSecure");
        MTKFB_MMP_Events.ConfigWDMASecure = MMProfileRegisterEvent(MTKFB_MMP_Events.UpdateConfig, "ConfigWDMASecure");
        MTKFB_MMP_Events.ConfigRDMASecure = MMProfileRegisterEvent(MTKFB_MMP_Events.UpdateConfig, "ConfigRDMASecure");
        MTKFB_MMP_Events.OvlReset = MMProfileRegisterEvent(MTKFB_MMP_Events.UpdateConfig, "OvlReset");
        MTKFB_MMP_Events.ClearWDMAIntr = MMProfileRegisterEvent(MTKFB_MMP_Events.UpdateConfig, "ClearWDMAIntr");
        MTKFB_MMP_Events.ClearRDMAIntr = MMProfileRegisterEvent(MTKFB_MMP_Events.UpdateConfig, "ClearRDMAIntr");
        MTKFB_MMP_Events.DciSessionError = MMProfileRegisterEvent(MTKFB_MMP_Events.UpdateConfig, "DciSessionError");
#endif
